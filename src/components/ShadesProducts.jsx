import products from "../data/shadesData";

export default function ShadesProducts() {
  return (
    <section className="w-full bg-[#f7f1e8] px-8 py-8">
      <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
        {products.map((item, index) => (
          <div
            key={index}
            className="bg-white rounded-2xl p-3 shadow-sm hover:shadow-lg transition-all duration-300 group cursor-pointer"
          >
            {/* Product Image */}
            <div className="relative overflow-hidden rounded-xl bg-[#f9f7f4]">
              ...
              {/* Cart Button */}
              <button className="absolute bottom-3 right-3 bg-gradient-to-r from-purple-500 to-pink-500 text-white rounded-full p-2.5 shadow-md">
                🛍
              </button>
            </div>
